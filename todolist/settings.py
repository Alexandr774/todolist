...
SECRET_KEY = 'django-insecure-dvelnmlses_m3wp^*-5fin10d#8h&+772s+kwkj7cftkd1tlo@' #env('SECRET_KEY')
...
MIDDLEWARE = [
    ...
    # 'social_django.middleware.SocialAuthExceptMiddleware',
]
...
SOCIAL_AUTH_OAUTH2_SCOPE = ['email']
